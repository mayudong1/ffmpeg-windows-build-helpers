...
build_ffmpeg() {
  ...
  cd $output_dir
    ...
    config_options="$init_options --enable-gray --enable-gnutls --enable-libass --enable-libmp3lame --enable-libopus --enable-libsoxr --enable-libspeex --enable-libopenjpeg --enable-demuxer=dash --enable-libxml2 "
